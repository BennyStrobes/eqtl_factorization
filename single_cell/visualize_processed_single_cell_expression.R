...
make_ct_proportion_per_individual_bar_plot <- function(filtered_covariate_data) {
  unique_indis <- as.character(unique(filtered_covariate_data$ind_cov))
  ...
  plotter <- ggplot(data=df, aes(x=indi, y=fraction, fill=cell_type)) +
          ...
          theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
          figure_theme() +
          labs(x = "Individual", y = "Fraction", fill= "") +
          theme(axis.text.x=element_blank(),
            axis.ticks.x=element_blank())
  return(plotter)
}
...
make_covariate_loading_correlation_heatmap <- function(covariates, loadings) {
  ...
  #print(summary(covariates))
  valid_covariates <- c(2, 3, 4, 5, 6, 8, 9, 10, 12, 13, 14, 15, 16, 17, 18, 19)
  covariate_type <- c("cat", "cat", "cat", "cat", "cat", "num", "num", "num", "num", "num", "num", "num", "num", "num", "num", "num")
...
# 2. Un-pooled expression w/ batch regression
# 3. KNN-pooled expression
# 4. Median gaussian kernel distance weighted knn-pooled expression
# 5. Adaptive gaussian kernel distance weighted knn-pooled expression

# VERSION FILES
# PCA
pca_files <- c("pca_scores_sle_individuals_min_expressed_cells_0.05_log_transform_transform.txt", "pca_scores_sle_individuals_min_expressed_cells_0.05_log_transform_transform_regress_out_batch_True.txt", "pca_scores_knn_boosted_k_90_euclidean_pca_regress_out_batch_True_sle_individuals.txt", "pca_scores_knn_boosted_k_30_euclidean_pca_median_gaussian_kernel_regress_out_batch_True_sle_individuals.txt", "pca_scores_knn_boosted_k_30_euclidean_pca_adaptive_gaussian_kernel_regress_out_batch_True_sle_individuals.txt", "none", "none", "none")
pca_pve_files <- c("pca_variance_explained_sle_individuals_min_expressed_cells_0.05_log_transform_transform.txt", "pca_variance_explained_sle_individuals_min_expressed_cells_0.05_log_transform_transform_regress_out_batch_True.txt", "pca_variance_knn_boosted_k_90_euclidean_pca_regress_out_batch_True_explained_sle_individuals.txt", "pca_variance_knn_boosted_k_30_euclidean_pca_median_gaussian_kernel_regress_out_batch_True_explained_sle_individuals.txt", "pca_variance_knn_boosted_k_30_euclidean_pca_adaptive_gaussian_kernel_regress_out_batch_True_explained_sle_individuals.txt", "none", "none", "none")
# Cell type summary files ("None" if not applicable)
ct_summary_files <- c("None", "None", "knn_mapping_cell_type_summary_k_90_euclidean_pca_regress_out_batch_True_sle_individuals.txt", "knn_mapping_cell_type_summary_k_30_euclidean_pca_median_gaussian_kernel_regress_out_batch_True_sle_individuals.txt", "knn_mapping_cell_type_summary_k_30_euclidean_pca_adaptive_gaussian_kernel_regress_out_batch_True_sle_individuals.txt", "knn_mapping_cell_type_summary_k_90_euclidean_pca_regress_out_batch_False_sle_individuals.txt", "knn_mapping_cell_type_summary_k_10_euclidean_pca_regress_out_batch_True_sle_individuals.txt", "knn_mapping_cell_type_summary_k_10_euclidean_pca_regress_out_batch_False_sle_individuals.txt")
# output stems
output_stems <- c("uncorrected_expression_", "corrected_expression_", "corrected_expression_knn_pooled_k_90_no_kernel_", "corrected_expression_knn_pooled_k_30_median_gaussian_kernel_", "corrected_expression_knn_pooled_k_30_adaptive_gaussian_kernel_", "uncorrected_expression_knn_pooled_k_90_no_kernel_", "corrected_expression_knn_pooled_k_10_no_kernel_", "uncorrected_expression_knn_pooled_k_10_no_kernel_")
