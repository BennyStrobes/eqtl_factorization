...
def bf_fdr_multiple_testing_correction(variant_gene_pairs_eqtl_results_file, multple_testing_correction_results_file):
...
####################
# Output file
multple_testing_correction_results_file = output_root + 'multiple_testing_bf_bh.txt'
# Perform bonferonni correction at variant level (per gene) and then BH at gene level
bf_fdr_multiple_testing_correction(variant_gene_pairs_eqtl_results_file, multple_testing_correction_results_file)
