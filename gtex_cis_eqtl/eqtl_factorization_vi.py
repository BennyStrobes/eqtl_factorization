...
class EQTL_FACTORIZATION_VI(object):
	...
	def update_elbo(self):
		...
		kl_divergence = kl_V_S + kl_U_S + kl_alpha + kl_gamma_v + kl_gamma_u + kl_tau + kl_psi + kl_theta_v + kl_theta_u + kl_intercept
