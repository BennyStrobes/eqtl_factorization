...
class EQTL_FACTORIZATION_VI(object):
	def __init__(self, K, alpha, beta, gamma_v, max_iter, delta_elbo_threshold):
	...
	def update_elbo(self):
		...
		kl_divergence = kl_V_S + kl_U_S + kl_F_S + kl_tau 
	...
	def initialize_variables(self):
		...
		self.F_mu = betas
		#self.F_mu = np.random.randn(self.T)*np.sqrt((1.0/self.gamma_v))
