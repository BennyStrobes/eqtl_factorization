...
class EQTL_FACTORIZATION_VI(object):
	def __init__(self, K, alpha, beta, a, b, lambda_v, max_iter, delta_elbo_threshold):
	...
	def update_elbo(self):
		...
		kl_divergence = kl_V + kl_U_S  + kl_gamma_u + kl_tau + kl_theta_u + kl_intercept
	...
	def initialize_variables(self):
		...
		self.U_var_s_0 = np.zeros((self.N, self.K))
